          ...
          <ScrollView contentContainerStyle={styles.scrollContent}>
            ...
            >
              <View style={styles.logoContainer}>
                ...
                <Text style={styles.appSubtitle}>Lien invalide</Text>
              ...
              <View style={styles.formContainer}>
                <Button
                  ...
                  textColor="#662d91"
                >
                  {i18nService.t('auth.forgotPassword.goToLogin')}
                </Button>
              </View>
            </Animated.View>
          </ScrollView>
          ...
          <ScrollView contentContainerStyle={styles.scrollContent}>
            ...
            >
              <View style={styles.logoContainer}>
                ...
                <Text style={styles.appTitle}>MULTITUDES</Text>
                <Text style={styles.appSubtitle}>{i18nService.t('auth.forgotPassword.passwordResetTitle')}</Text>
                <Text style={styles.appDescription}>
                  {i18nService.t('auth.forgotPassword.passwordResetSuccess')}
                </Text>
                <View style={styles.titleUnderline} />
              </View>
              <View style={styles.formContainer}>
        ...
        >
          ...
          >
            <View style={styles.logoContainer}>
              ...
              <Text style={styles.appTitle}>MULTITUDES</Text>
              <Text style={styles.appSubtitle}>Nouveau mot de passe</Text>
              <Text style={styles.appDescription}>
            ...
            <View style={styles.formContainer}>
              ...
              >
                ...
                <Text style={styles.backButtonText}>Retour à la demande de réinitialisation</Text>
              </TouchableOpacity>
            </View>
          </Animated.View>
        </ScrollView>
